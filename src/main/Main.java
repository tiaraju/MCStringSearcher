...
public class Main {
	...
	private static boolean runBruteForceExperiment(String text,
			String pattern) {
	...
	private static boolean runKnuthMorrisExperiment(String text,
			String pattern) {
		searcher = new KnuthMorrisPratt();
		return searcher.searchPattern(pattern, text);
	}

	private static boolean runRabinKarpExperiment(String text,
			String pattern) {
